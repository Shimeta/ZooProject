...
public class Main {
	...
	public static void main(String[] args) {
		...
		sayan_zoo.addGehege(2, landsaeugetier_gehege_names[0], sayan_zoo);
		sayan_zoo.addGehege(2, landsaeugetier_gehege_names[1], sayan_zoo);
		sayan_zoo.addGehege(2, landsaeugetier_gehege_names[2], sayan_zoo);
