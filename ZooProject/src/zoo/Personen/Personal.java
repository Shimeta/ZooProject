...
import zoo.Tier.Tier;		//frag mich ob personal das benutzen mÃ¼sst also wegen ITier & lebtin
...
public class Personal extends Personen {
	...
	public void betreut(Gehege[] gehege) {
		...
		//weil zu Beginn ja mit der Länge 10 initialisiert war(siehe -> Gehege Konstruktor)
		int gehege_length = 0;
